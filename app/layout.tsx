...
export const metadata: Metadata = {
  ...
  description: 'Allow peace and tranquility to arrive at Aksari, a luxury coastal resort destination offering unparalleled experiences and timeless elegance.',
  generator: 'v0.app',
